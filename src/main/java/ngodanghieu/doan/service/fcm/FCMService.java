...
import ngodanghieu.doan.request.PushNotificationRequest;
...
public class FCMService {
    ...
    private AndroidConfig getAndroidConfig(String topic) {
        return AndroidConfig.builder()
                ...
                .setNotification(AndroidNotification.builder().setSound(Constant.NotificationParameter.SOUND.getValue())
                        .setColor(Constant.NotificationParameter.COLOR.getValue()).setTag(topic).build()).build();
    }

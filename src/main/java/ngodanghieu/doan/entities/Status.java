 ...
 */
@Entity
@Table(name = "status", catalog = "ngodanghieu")
public class Status implements java.io.Serializable {
	...
	public Status(String statusCode, String statusName, Date createdOn, String createdBy) {
	...
	public Status(String statusCode, String statusName, Date createdOn, String createdBy, Set<User> users,
